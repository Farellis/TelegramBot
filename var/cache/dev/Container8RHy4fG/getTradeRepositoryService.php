 ...
 */
class getTradeRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TradeRepository.php';

        return $container->privates['App\\Repository\\TradeRepository'] = new \App\Repository\TradeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
