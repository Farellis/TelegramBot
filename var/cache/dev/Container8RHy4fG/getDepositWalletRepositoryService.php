 ...
 */
class getDepositWalletRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DepositWalletRepository' shared autowired service.
     *
     * @return \App\Repository\DepositWalletRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DepositWalletRepository.php';

        return $container->privates['App\\Repository\\DepositWalletRepository'] = new \App\Repository\DepositWalletRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
