 ...
 */
class getNetworkRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NetworkRepository.php';

        return $container->privates['App\\Repository\\NetworkRepository'] = new \App\Repository\NetworkRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
