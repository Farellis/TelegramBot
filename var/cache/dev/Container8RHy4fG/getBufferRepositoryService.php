 ...
 */
class getBufferRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BufferRepository' shared autowired service.
     *
     * @return \App\Repository\BufferRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BufferRepository.php';

        return $container->privates['App\\Repository\\BufferRepository'] = new \App\Repository\BufferRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
